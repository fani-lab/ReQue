...
easy_word_set = set([ln.strip() for ln in open(os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe()))) + '/easy_words.txt')])
...
class textstatistics:
    ...
    def text_standard(self, text):
        ...
        return int(score)#str(int(score)-1) + "th " + "and " + str(int(score)) + "th grade"
